...
export default function Leaderboard() {
    ...
    useEffect(()=>{
       ...
       return (
            ...
            <div data-testid='leaderboard' className="flex flex-col w-4/5 h-fit bg-gradient-to-b from-[#272727] to-[#797979] self-center items-center border-[5px] border-white">  
                <LBHeader></LBHeader>
